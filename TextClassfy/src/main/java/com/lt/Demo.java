...
public class Demo {
    ...
    public static void runTrainAndTest() {
        ...
        String defaultArguments = ""
                + "-train E:\\codeRepository\\textClassifier\\THUCNews "  // 设置您的训练路径，这里的路径只是给出样例
                + "-test E:\\codeRepository\\textClassifier\\THUCNews "
    ...
    public static void runLoadModelAndUse() {
        ...
        // 设置分类种类，并读取模型
        classifier.loadCategoryListFromFile("E:\\codeRepository\\JavaAll\\TextClassfy\\news_model\\category");
        classifier.setTextClassifier(new LinearBigramChineseTextClassifier(classifier.getCategorySize()));
        classifier.getTextClassifier().loadModel("E:\\codeRepository\\JavaAll\\TextClassfy\\news_model");
